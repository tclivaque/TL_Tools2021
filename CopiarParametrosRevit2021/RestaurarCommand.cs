...
public class RestaurarCommand : IExternalCommand
{
        ...
        try
        {
            ...
            else
            {
                ...
                referenciasElementos = uidoc.Selection.PickObjects(ObjectType.Element,
                    "Selecciona los elementos para restaurar");
            }
            ...
            using (Transaction t = new Transaction(doc, "Restaurar - Limpiar parámetros"))
            {
                t.Start();
                ...
                foreach (Reference r in referenciasElementos)
                {
                    try
                    {
                        ...
                        // Parámetros booleanos - poner en False (0)
