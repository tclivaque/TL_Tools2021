...
public class SolaqueoCommand : IExternalCommand
{
        ...
        try
        {
            ...
            else
            {
                ...
                referenciasElementos = uidoc.Selection.PickObjects(ObjectType.Element,
                    "Selecciona los elementos para solaqueo");
            }
            ...
            using (Transaction t = new Transaction(doc, "Solaqueo - Asignación MET_SUP"))
            {
                t.Start();
